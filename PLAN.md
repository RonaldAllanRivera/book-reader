...
- **Tkinter GUI, screenshot-based (current implementation):**
  ...
  - For each page you want to "read":
    ...
    - The book screenshot thumbnail strip is scrollable to support large sets (e.g., 100+ screenshots) and make it easy to delete any page.
  ...
  - When you have pasted all pages for a session, click **"2. Transcribe Book Screenshots"**:
    ...
    - You can use **"Copy Book Transcript"** to copy all transcribed pages to the clipboard in page order.
